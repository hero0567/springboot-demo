...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.levy.grpc.generate.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getSayHelloMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.levy.grpc.generate.Person,
      com.levy.grpc.generate.Greeting> METHOD_SAY_HELLO = getSayHelloMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.levy.grpc.generate.Person,
      com.levy.grpc.generate.Greeting> getSayHelloMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.levy.grpc.generate.Person,
      com.levy.grpc.generate.Greeting> getSayHelloMethod() {
    return getSayHelloMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.levy.grpc.generate.Person,
      com.levy.grpc.generate.Greeting> getSayHelloMethodHelper() {
    io.grpc.MethodDescriptor<com.levy.grpc.generate.Person, com.levy.grpc.generate.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.levy.grpc.generate.Person, com.levy.grpc.generate.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.levy.grpc.generate.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.levy.grpc.generate.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.levy.grpc.generate.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.levy.grpc.generate.Person request,
        io.grpc.stub.StreamObserver<com.levy.grpc.generate.Greeting> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.levy.grpc.generate.Person,
                com.levy.grpc.generate.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.levy.grpc.generate.Greeting sayHello(com.levy.grpc.generate.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.levy.grpc.generate.Greeting> sayHello(
        com.levy.grpc.generate.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.levy.grpc.generate.Person) request,
              (io.grpc.stub.StreamObserver<com.levy.grpc.generate.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.levy.grpc.generate.HelloWorld.getDescriptor();
    }
